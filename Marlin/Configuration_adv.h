...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 6*60, 2*60 } // Feedrates for manual moves along X, Y, Z, E from panel
...
#define ADVANCED_PAUSE_FEATURE
  ...
  //#define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   6  // (mm/s) Load filament feedrate. This can be pretty fast.                                                  // 0 to disable start loading and skip to fast load only
 ...
 */
  ...
  #define E1_HYBRID_THRESHOLD    120
