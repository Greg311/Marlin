...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  23.62,  23.62 }
    #define DEFAULT_Ki_LIST {   1.27,   1.27 }
    #define DEFAULT_Kd_LIST { 109.45, 109.45 }
  #else
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 397.5 }        //16  with Hemera 397.5 low
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -33, -0.91 }
